    ...
    if request.xhr?
      ...
      if content_types.has_key? content_type.to_sym
        ...
        render :update do | page |
          ...
          page << "GEvent.addListener( postcontentmap, 'zoomend', function( oldLevel, newLevel ) { postcontentmap.removeOverlay( poiBounds ); poiBounds = GCircle( postcontentmap, new GLatLng( #{ @poi.lat }, #{ @poi.lng } ), new GLatLng( #{ @poi.lat }, #{ @poi.lng } + 0.004166666666667 ), '#000000', '#79AB75' ); postcontentmap.addOverlay( poiBounds ); } );"
