...
class Admin::MapLayersController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     MapLayer: create, read, update, destroy, custom_action
  #
  #   editor:
  #     MapLayer: create, read, update, custom_action_for_an_item
  #
