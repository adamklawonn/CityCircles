...
class Admin::UserLocationsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     UserLocation: create, read, update, destroy, custom_action
  #
  #   editor:
  #     UserLocation: create, read, update, custom_action_for_an_item
  #
