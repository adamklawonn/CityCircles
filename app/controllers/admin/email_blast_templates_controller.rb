...
class Admin::EmailBlastTemplatesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     EmailBlastTemplate: create, read, update, destroy, custom_action
  #
  #   editor:
  #     EmailBlastTemplate: create, read, update, custom_action_for_an_item
  #
