...
class Admin::AdsController < Admin::MasterController

  def deliver_ad_approval
    #debugger
  end
...
=begin
  ...
  #
  #   admin:
  #     Ad: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Ad: create, read, update, custom_action_for_an_item
  #
