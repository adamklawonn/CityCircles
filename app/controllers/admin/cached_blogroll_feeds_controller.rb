...
class Admin::CachedBlogrollFeedsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     CachedBlogrollFeed: create, read, update, destroy, custom_action
  #
  #   editor:
  #     CachedBlogrollFeed: create, read, update, custom_action_for_an_item
  #
