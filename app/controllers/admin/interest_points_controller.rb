...
class Admin::InterestPointsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     InterestPoint: create, read, update, destroy, custom_action
  #
  #   editor:
  #     InterestPoint: create, read, update, custom_action_for_an_item
  #
