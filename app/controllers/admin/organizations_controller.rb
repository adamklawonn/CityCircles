...
class Admin::OrganizationsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Organization: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Organization: create, read, update, custom_action_for_an_item
  #
