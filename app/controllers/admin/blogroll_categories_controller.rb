...
class Admin::BlogrollCategoriesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     BlogrollFeed: create, read, update, destroy, custom_action
  #
  #   editor:
  #     BlogrollFeed: create, read, update, custom_action_for_an_item
  #
