...
class Admin::MapIconsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     MapIcon: create, read, update, destroy, custom_action
  #
  #   editor:
  #     MapIcon: create, read, update, custom_action_for_an_item
  #
