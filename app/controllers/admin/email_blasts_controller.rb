...
class Admin::EmailBlastsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     EmailBlast: create, read, update, destroy, custom_action
  #
  #   editor:
  #     EmailBlast: create, read, update, custom_action_for_an_item
  #
