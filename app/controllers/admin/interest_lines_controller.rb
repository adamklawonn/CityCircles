...
class Admin::InterestLinesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     InterestLine: create, read, update, destroy, custom_action
  #
  #   editor:
  #     InterestLine: create, read, update, custom_action_for_an_item
  #
