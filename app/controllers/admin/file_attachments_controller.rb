...
class Admin::FileAttachmentsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     FileAttachment: create, read, update, destroy, custom_action
  #
  #   editor:
  #     FileAttachment: create, read, update, custom_action_for_an_item
  #
