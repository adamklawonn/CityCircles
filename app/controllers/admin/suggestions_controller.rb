...
class Admin::SuggestionsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Suggestion: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Suggestion: create, read, update, custom_action_for_an_item
  #
