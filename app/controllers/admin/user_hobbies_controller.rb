...
class Admin::UserHobbiesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     UserHobby: create, read, update, destroy, custom_action
  #
  #   editor:
  #     UserHobby: create, read, update, custom_action_for_an_item
  #
