...
class Admin::OrganizationMembersController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     OrganizationMember: create, read, update, destroy, custom_action
  #
  #   editor:
  #     OrganizationMember: create, read, update, custom_action_for_an_item
  #
