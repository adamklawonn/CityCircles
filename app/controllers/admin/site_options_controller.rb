...
class Admin::SiteOptionsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     SiteOption: create, read, update, destroy, custom_action
  #
  #   editor:
  #     SiteOption: create, read, update, custom_action_for_an_item
  #
