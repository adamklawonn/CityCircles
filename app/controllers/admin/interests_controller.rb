...
class Admin::InterestsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Interest: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Interest: create, read, update, custom_action_for_an_item
  #
