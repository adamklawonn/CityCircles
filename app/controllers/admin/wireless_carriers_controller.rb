...
class Admin::WirelessCarriersController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     WirelessCarrier: create, read, update, destroy, custom_action
  #
  #   editor:
  #     WirelessCarrier: create, read, update, custom_action_for_an_item
  #
