...
class Admin::UserWirelessProfilesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     UserWirelessProfile: create, read, update, destroy, custom_action
  #
  #   editor:
  #     UserWirelessProfile: create, read, update, custom_action_for_an_item
  #
