...
class Admin::PostTypesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     PostType: create, read, update, destroy, custom_action
  #
  #   editor:
  #     PostType: create, read, update, custom_action_for_an_item
  #
