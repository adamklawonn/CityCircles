...
module ApplicationHelper
  ...
  def generate_poi_post_map( poi )
    ...
    post_gmap.record_init "GEvent.addListener( postcontentmap, 'click', function( overlay, latlng, overlaylatlng ) { if( overlaylatlng != undefined ) { $( 'lat' ).value = overlaylatlng.lat();$( 'lng' ).value = overlaylatlng.lng();$( 'lat' ).value = overlaylatlng.lat();$( 'lng' ).value = overlaylatlng.lng(); } } );"
